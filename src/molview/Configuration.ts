...
export class Configuration {
    ...
    public static domElement: string = "wglContent"; // DOM element id to attach molecule renderer
    public static infoElement: string = "wglInfo";    // DOM element id to write info text output
